"""
Django settings for bitter_violet_dev_133402 project.
...
ROOT_URLCONF = 'bitter_violet_dev_133402.urls'
...
WSGI_APPLICATION = 'bitter_violet_dev_133402.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bitter_violet_dev_133402 API",
    "DESCRIPTION": "API documentation for bitter_violet_dev_133402 App",
    "VERSION": "v1",
}
